...
// user include files
#include "ExhumeProducerAnalyzer.h"
...
ExhumeProducerAnalyzer::ExhumeProducerAnalyzer(const edm::ParameterSet& iConfig){
...
void ExhumeProducerAnalyzer::beginJob(edm::EventSetup const&iSetup) {}

ExhumeProducerAnalyzer::~ExhumeProducerAnalyzer() {}

// ------------ method called to for each event  ------------
void
ExhumeProducerAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void ExhumeProducerAnalyzer::endJob() {
...
DEFINE_FWK_MODULE(ExhumeProducerAnalyzer);
